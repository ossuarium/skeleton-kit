...
Create and enter a new directory for your kit and run

  $ git init
  $ git pull git://github.com/razor-x/kits_skeleton.git
...
The {kit skeleton source}[https://github.com/razor-x/kits_skeleton] is currently hosted at github.
