...
To generate a new migration, run
  $ rake mk_migration[new_migration_name]
in the kit's root directory.
This will create a new migration file named +UNIX_TIME_STAMP_new_migration_name.rb+.
Every new kit starts with the migration +CreateBasicTables+.
