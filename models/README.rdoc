...
All kits start with the models +Bit+, +Group+, +User+, and +Permission+, but you can still create your these model files here to add custom functionality to these basic models.